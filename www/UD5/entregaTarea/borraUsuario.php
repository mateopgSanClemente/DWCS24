<?php
    ...
    // Redirigir a index en caso de que la persona que pretende acceder lo haga sin ser administrador
    if ($_SESSION["rol"] !== 1) {
    ...
    if(!$resultado_conexion_PDO["success"]){
        ...
        // Eliminar usuario
        $resultado_eliminar_usuario = eliminar_usuario($conexion_PDO, $usuario);
        // Mostrar resultado
